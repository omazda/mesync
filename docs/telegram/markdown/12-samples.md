...
> Источник: https://core.telegram.org/bots/samples  
...
* **tgbotrs**. A strongly-typed, async Rust client for the Telegram Bot API, generated from the official spec.
  <https://github.com/ankit-chaubey/tgbotrs>
* **telers**. An asynchronous framework for Telegram Bot API written in Rust.
  <https://github.com/Desiders/telers>
...
* **Telecr**, A modern fiber based Crystal framework for Telegram bots.
  <https://github.com/slick-lab/telecr>
* **hamilton**, Telegram Bot API wrapper for Crystal.
