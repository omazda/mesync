...
> Источник: https://core.telegram.org/bots/features  
...
* You can then control the new bot via the Bot API, receive and respond to messages, change its [profile](/bots/api#setmyprofilephoto), [settings](https://core.telegram.org/bots/api#setmycommands) and more.
...
* Your interfaces, texts and [inline results](/bots/api#answerinlinequery) should adapt seamlessly to the *language\_code*, without user intervention.
* Connected [WebApps](/bots/webapps) will receive the user's *language\_code* – your HTML page should account for it.
* [HTML5 Games](/bots/games) can obtain language information if you specify it as a [URL parameter](/bots/games#using-url-parameters). You can generate this parameter from the *language\_code* field in the [User](/bots/api#user) object served with the initial game [CallbackQuery](/bots/api#callbackquery).
...
| --- | --- | --- | --- | --- | --- |
| [Official](/bots/api#making-requests) | 20MB | 50MB | HTTPS | 443,80,88,8443 | 1-100 |
| [Local](/bots/api#using-a-local-bot-api-server) | Unlimited | 2000MB | HTTP | Any port | 1-100000 |
